...
#define I2S_MIC_SERIAL_CLOCK GPIO_NUM_22 //SCK - BCLK
#define I2S_MIC_LEFT_RIGHT_CLOCK GPIO_NUM_21 //WS - LRC
#define I2S_MIC_SERIAL_DATA GPIO_NUM_19 //SD
...
#define I2S_SPEAKER_SERIAL_CLOCK GPIO_NUM_22 //BCLK
#define I2S_SPEAKER_LEFT_RIGHT_CLOCK GPIO_NUM_21 //LRC
